...
const ChatHeader = () => {
  ...
  return (
    // Gradient: Solid Black (Top) -> Fade -> Transparent (Bottom)
    <LinearGradient
    ...
    >
      ...
      <TouchableOpacity
        activeOpacity={0.8}
        style={styles.circleButton}
        onPress={() => navigation.navigate('Notifications')} // <--- Updated Navigation
      >
        <Image
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingTop: 15,    // Standard padding for top status bar area
    paddingBottom: 40, // Increased bottom padding to extend the fade-out effect
    width: '100%',
  },
  leftSection: {
    flexDirection: 'row',

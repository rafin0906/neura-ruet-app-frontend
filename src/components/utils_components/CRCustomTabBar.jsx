...
// Icon Assets (Ensure you have a material icon or reuse result icon temporarily)
const ICONS = {
    ChatBotScreen: require('../../../assets/icons/chat_bot_tab_icon.png'),
    NoticeUpScreen: require('../../../assets/icons/notice_up_tab_icon.png'),
    MaterialUpScreen: require('../../../assets/icons/result_create_tab_icon.png'), // Use suitable icon
};
                    ...
                    styles.itemWrapper, 
                    {
                        ...
                        backgroundColor: isFocused
                            ? pillAnim.interpolate({
                                inputRange: [0, 1],
                                outputRange: ['transparent', '#99EF5E'] 
                            })
                            : 'transparent',
...
const CRCustomTabBar = ({ state, descriptors, navigation }) => {
    return (
